(function (root) {
  ...
  SF.add({
    id: 'yahoo-jp', currency: 'JPY', flag: '', platform: 'Yahoo! Shopping', region: 'JP', countries: ['JP'], names: {ja: 'Yahoo!ショッピング',ko: '야후 재팬'}, primary: ['payM', 'royalty'],
    ...
    s: {
      ...
      en: { title: 'Yahoo! Shopping Japan Fee Calculator 2026 – Monthly Fee, Royalty & Profit', desc: 'Calculate Yahoo! Shopping Japan fees after the September 2026 change: ¥10,000 monthly system fee, 2.5 % sales royalty, payment fee, store point funding and affiliate, with payout, net profit and break-even price.', h1: 'Yahoo! Shopping Japan Fee Calculator (2026)', intro: 'From September 2026 Yahoo! Shopping is no longer free to sell on: a ¥10,000 monthly system fee (ex tax) and a 2.5 % sales royalty were introduced, while the 1.5 % campaign funding charge was abolished. On top come the payment fee (PayPay 3.0 %, card 3.24 %, carrier billing 4.48 %), store point funding of 1–15 % and affiliate rewards. Enter your monthly orders and the fixed fee is spread per order.',
