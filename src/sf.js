...
(function (root) {
  ...
  SF.I18N = {
    ...
    fr: { exampleH: "Exemple chiffré", exampleLead: "Valeurs d’exemple, pour voir le calcul avant de saisir les vôtres.", advanced: "Paramètres avancés", sysfeeShort: "Frais système", marketplace: "Marketplace", compareH: "Comparer les marketplaces", sharedInputs: "Votre produit", bestFirst: "Trié par bénéfice net", langName: 'Français', languages: 'Langues', price: 'Prix de vente', shipping: 'Frais de port facturés à l’acheteur', cost: 'Coût d’achat', shipCost: 'Vos frais d’expédition', category: 'Catégorie', commission: 'Commission %', orders: 'Commandes par mois', vatStatus: 'Statut TVA', vatDeduct: 'Assujetti à la TVA – TVA sur les frais récupérable', vatCost: 'Non assujetti (franchise en base) – TVA sur les frais = coût', otherPct: 'Autres coûts % (pub, etc.)', otherCost: 'Autres coûts', vatOnFees: 'TVA sur les frais', targetProfit: 'Bénéfice cible (optionnel)', results: 'Résultats', feesTotal: 'Total des frais', payout: 'Montant reversé', profit: 'Bénéfice net', margin: 'Marge', roi: 'ROI', breakEven: 'Prix d’équilibre', requiredPrice: 'Prix pour le bénéfice cible', feeBreakdown: 'Détail des frais', editableNote: 'Les taux sont préremplis d’après la grille officielle et entièrement modifiables.', disclaimer: 'Estimation uniquement. Vérifiez les taux en vigueur dans votre espace vendeur.', updated: 'Mise à jour', sources: 'Sources', otherCalcs: 'Autres calculateurs', reset: 'Réinitialiser', feeTableH: 'Grille des frais', faqH: 'Questions fréquentes', home: 'Tous les calculateurs', ratesH: 'Taux',
