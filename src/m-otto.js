(function (root) {
  ...
  SF.add({
    ...
    s: {
      de: { title: 'OTTO Market Gebührenrechner 2026 – Provision, Grundgebühr, Nettogewinn', desc: 'OTTO-Market-Gebühren berechnen: 5–22 % Provision je Kategorie auf den Bruttoverkaufspreis, 16 % auf Versandkosten, 99,90 € Grundgebühr pro Bestellung umgelegt, USt, Auszahlung und Nettogewinn.', h1: 'OTTO Market Gebührenrechner (2026)', intro: 'OTTO Market kostet 99,90 € netto Grundgebühr pro Monat plus eine Verkaufsprovision von 5 bis 22 % je nach Kategorie und Preisstufe, berechnet auf den Bruttoverkaufspreis. Auf die vom Kunden gezahlten Versandkosten kommen 16 %. Die Zahlungsgebühr von 2,7 % ist in der Provision bereits enthalten. Der Rechner legt die Grundgebühr auf deine Bestellungen um und zeigt Gebühren, Auszahlung und Nettogewinn.',
      ...
      en: { title: 'OTTO Market Fee Calculator 2026 – Commission, Base Fee & Net Profit', desc: 'Calculate OTTO Market (Germany) fees: 5–22 % commission by category on the gross price, 16 % on shipping, €99.90 base fee spread per order, VAT, payout and net profit.', h1: 'OTTO Market Fee Calculator (2026)', intro: 'OTTO Market costs €99.90 net per month plus a sales commission of 5 to 22 % depending on category and price tier, charged on the gross selling price. Shipping paid by the customer is charged a separate 16 %. The 2.7 % payment fee is already inside the commission. The calculator spreads the base fee over your orders and shows fees, payout and net profit.',
