(function (root) {
  ...
  SF.add({
    ...
    s: {
      ...
      en: { title: 'Gmarket & Auction Fee Calculator 2026 – Category Service Fee & Margin', desc: 'Calculate Gmarket and Auction (ESM, Korea) seller fees: 6.5–13 % category service fee, 3.3 % paid-shipping fee and server fee, with payout, net profit, margin and break-even price.', h1: 'Gmarket & Auction Fee Calculator (2026)', intro: 'Gmarket and Auction run on the same ESM Plus back end and share one fee schedule. The service fee is 6.5–13 % by category, charged on the selling price plus option price. Paid shipping adds a separate 3.3 %. Pick a category to see payout, net profit and break-even price.',
