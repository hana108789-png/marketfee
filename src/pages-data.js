        ...
        en: {
          ...
          body: [
            ...
            ['What we measure',
              ...
              'That event carries no identifier of any kind. There is no cookie, no device fingerprint and no account, so the records cannot be linked to you or to each other. The one exception is a yes or no: whether this browser has been here on an earlier day. Your browser keeps the date of your last visit and works that out itself; only the yes or no is sent, never the date. We learn that a visit is a return, not whose it is. In European time zones this is skipped and nothing is stored for it.'],
        ...
        ko: {
          ...
          body: [
            ...
            ['무엇을 측정하나',
              ...
              '이 기록에는 어떤 식별자도 들어가지 않습니다. 쿠키도, 기기 지문도, 계정도 없어서 기록을 개인과 연결하거나 기록끼리 묶을 수 없습니다. 예외는 단 하나, 이 브라우저가 이전 날짜에 방문한 적이 있는지에 대한 예/아니오입니다. 브라우저가 마지막 방문 날짜를 보관하고 스스로 판단하며, 전송되는 것은 예/아니오뿐이고 날짜는 보내지 않습니다. 저희는 다시 온 방문이라는 것만 알 뿐 누구인지는 알지 못합니다. 유럽 시간대에서는 이 기능을 쓰지 않고 아무것도 저장하지 않습니다.'],
            ['기기에 남는 것',
        ...
        ja: {
          ...
          body: [
            ...
            ['計測する内容',
              ...
              'この記録にはいかなる識別子も含まれません。クッキーも端末フィンガープリントもアカウントもないため、記録を個人に結びつけることも、記録同士を紐づけることもできません。唯一の例外は、このブラウザが以前の日に訪問したことがあるかどうかの「はい／いいえ」です。ブラウザが前回の訪問日を保存して自ら判定し、送信されるのは「はい／いいえ」だけで日付は送りません。当サイトに分かるのは再訪であることだけで、誰かは分かりません。ヨーロッパのタイムゾーンではこの機能を使わず、何も保存しません。'],
            ['端末に残るもの',
        ...
        de: {
          ...
          body: [
            ...
            ['Was wir messen',
              ...
              'Dieses Ereignis enthält keinerlei Kennung. Es gibt kein Cookie, keinen Geräte-Fingerabdruck und kein Konto, daher lassen sich die Datensätze weder Ihnen noch einander zuordnen. Die einzige Ausnahme ist ein Ja oder Nein: ob dieser Browser schon an einem früheren Tag hier war. Ihr Browser speichert das Datum Ihres letzten Besuchs und ermittelt das selbst; gesendet wird nur Ja oder Nein, nie das Datum. Wir erfahren, dass ein Besuch eine Rückkehr ist, nicht von wem. In europäischen Zeitzonen entfällt das, und dafür wird nichts gespeichert.'],
        ...
        fr: {
          ...
          body: [
            ...
            ['Ce que nous mesurons',
              ...
              'Cet événement ne porte aucun identifiant. Pas de cookie, pas d’empreinte d’appareil, pas de compte : les enregistrements ne peuvent être rattachés ni à vous ni les uns aux autres. Seule exception, un oui ou non : ce navigateur est-il déjà venu un jour précédent. Votre navigateur conserve la date de votre dernière visite et le détermine lui-même ; seul le oui ou non est envoyé, jamais la date. Nous savons qu’une visite est un retour, pas de qui elle vient. Dans les fuseaux horaires européens, cette fonction est désactivée et rien n’est stocké à cet effet.'],
        ...
        nl: {
          ...
          body: [
            ...
            ['Wat we meten',
              ...
              'Die gebeurtenis draagt geen enkele identificatie. Er is geen cookie, geen apparaatvingerafdruk en geen account, dus de records zijn niet aan jou en niet aan elkaar te koppelen. De enige uitzondering is een ja of nee: of deze browser op een eerdere dag al eens hier was. Je browser bewaart de datum van je laatste bezoek en bepaalt dat zelf; alleen het ja of nee wordt verstuurd, nooit de datum. We weten dat een bezoek een terugkeer is, niet van wie. In Europese tijdzones gebeurt dit niet en wordt er niets voor opgeslagen.'],
        ...
        it: {
          ...
          body: [
            ...
            ['Cosa misuriamo',
              ...
              'Quell’evento non porta alcun identificativo. Non ci sono cookie, impronte del dispositivo né account, quindi i record non sono collegabili a te né tra loro. L’unica eccezione è un sì o no: se questo browser è già stato qui in un giorno precedente. Il tuo browser conserva la data dell’ultima visita e lo determina da solo; viene inviato solo il sì o no, mai la data. Sappiamo che una visita è un ritorno, non di chi sia. Nei fusi orari europei la funzione è disattivata e non viene salvato nulla a questo scopo.'],
        ...
        es: {
          ...
          body: [
            ...
            ['Qué medimos',
              ...
              'Ese evento no lleva ningún identificador. No hay cookie, ni huella de dispositivo, ni cuenta, así que los registros no pueden vincularse contigo ni entre sí. La única excepción es un sí o no: si este navegador ya estuvo aquí un día anterior. Tu navegador guarda la fecha de tu última visita y lo calcula por sí mismo; solo se envía el sí o no, nunca la fecha. Sabemos que una visita es un regreso, no de quién es. En las zonas horarias europeas esto se omite y no se guarda nada para ello.'],
